...
from tests.storage.restricted_namespace_cloning.utils import create_dv_negative, verify_snapshot_transfer_for_dv
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            {"dv_name": "cnv-2692"},
            True,  # only this param will create VM
        ...
        pytest.param(
            ...
            {"dv_name": "cnv-2971"},
            False,  # no VM creation for this param
...
def test_user_permissions_positive(
    ...
    if create_vm:
        create_vm_from_dv(dv=dv_destination_cloned_from_pvc)
